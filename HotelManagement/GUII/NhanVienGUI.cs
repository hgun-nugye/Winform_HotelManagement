...
namespace HotelManagement
{
    public partial class bangNV : Form
    {
        ...
        private void dataGridViewNV_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            textGioiTinh.Text = dataGridViewNV.Rows[index].Cells["GioiTinh"].Value.ToString();
        ...
        public bool checkData()
        {
            ...
            if (string.IsNullOrEmpty(textGioiTinh.Text))
            {
                MessageBox.Show("Chưa nhập giới tính", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                textGioiTinh.Focus();
                return false;
            }
