namespace HotelManagement
{
	partial class bangHoaDonMon
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridViewHDM.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
